...
class IconButton(Button):
    ...
    def __init__(
        ...
        bg_color: pygame.Color = Colors.ui.button_disabled,
        hover_color: pygame.Color = Colors.feedback.error,
        icon_color: pygame.Color = Colors.text.primary,
        icon_hover_color: pygame.Color = Colors.text.on_brand,
